(function() {
  var ProxyServer, crypto, elf, fs, h, http, insert_counter, pg, query_counter, query_error_counter, sys, update_counter, upsert_counter, upsert_error_counter, upsert_row_counter, url, _;
  sys = require('sys');
  fs = require('fs');
  http = require('http');
  url = require('url');
